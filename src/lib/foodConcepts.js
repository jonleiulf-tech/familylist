...
export const CONCEPTS = [
  // ── Kjøtt ──────────────────────────────────────────────────────────────
  { id: 'kjottdeig', label: 'Kjøttdeig', syn: ['kjøttdeig', 'karbonadedeig', 'hakket storfe'], kcal: 176, protein: 19, g: null, role: 'bearing' },
  ...
  { id: 'svinekjott', label: 'Svinekjøtt', syn: ['svin', 'svinekjøtt', 'svinefilet', 'koteletter', 'nakkekoteletter', 'ribbe'], kcal: 210, protein: 20, g: 180, role: 'bearing' },
  ...
  { id: 'lam', label: 'Lammekjøtt', syn: ['lam', 'lammelår', 'fårikål'], kcal: 230, protein: 19, g: 200, role: 'bearing' },
  { id: 'bacon', label: 'Bacon', syn: ['bacon', 'sideflesk'], kcal: 380, protein: 14, g: null, role: 'bearing' },
  { id: 'polse', label: 'Pølse', syn: ['pølse', 'pølser', 'grillpølse', 'wienerpølse', 'chorizo'], kcal: 260, protein: 12, g: 70, role: 'bearing' },
  { id: 'skinke', label: 'Skinke', syn: ['skinke', 'kokt skinke', 'spekeskinke'], kcal: 130, protein: 18, g: null, role: 'bearing' },
  { id: 'kjottkaker', label: 'Kjøttkaker', syn: ['kjøttkaker', 'karbonader', 'medisterkaker'], kcal: 220, protein: 14, g: 60, role: 'bearing' },

  // ── Fisk og sjømat ─────────────────────────────────────────────────────
  { id: 'laks', label: 'Laks', syn: ['laks', 'laksefilet', 'røkelaks'], kcal: 208, protein: 20, g: 150, role: 'bearing' },
  ...
  { id: 'fiskepinner', label: 'Fiskepinner', syn: ['fiskepinner', 'fiskekaker', 'fiskeboller'], kcal: 200, protein: 12, g: 30, role: 'bearing' },
  ...
  { id: 'kikerter', label: 'Kikerter', syn: ['kikerter', 'kikerte'], kcal: 130, protein: 7, g: null, role: 'bearing' },
  { id: 'linser', label: 'Linser', syn: ['linser', 'røde linser'], kcal: 116, protein: 9, g: null, role: 'bearing' },
  { id: 'bonner', label: 'Bønner', syn: ['bønner', 'kidneybønner', 'sorte bønner', 'hvite bønner'], kcal: 127, protein: 8, g: null, role: 'bearing' },
  ...
  { id: 'flote', label: 'Fløte', syn: ['fløte', 'kremfløte', 'matfløte'], kcal: 340, protein: 2, g: null, role: 'normal' },
  { id: 'romme', label: 'Rømme', syn: ['rømme', 'lettrømme', 'seterrømme'], kcal: 190, protein: 3, g: null, role: 'normal' },
  { id: 'creme_fraiche', label: 'Crème fraîche', syn: ['creme fraiche', 'crème fraîche'], kcal: 220, protein: 3, g: null, role: 'normal' },
  { id: 'ost', label: 'Ost', syn: ['ost', 'norvegia', 'jarlsberg', 'gulost', 'revet ost'], kcal: 350, protein: 25, g: null, role: 'normal' },
  { id: 'fetaost', label: 'Fetaost', syn: ['feta', 'fetaost', 'salatost'], kcal: 260, protein: 14, g: null, role: 'normal' },
  { id: 'smor', label: 'Smør', syn: ['smør', 'meierismør'], kcal: 740, protein: 0.5, g: null, role: 'background' },
  { id: 'yoghurt', label: 'Yoghurt', syn: ['yoghurt', 'gresk yoghurt', 'skyr'], kcal: 62, protein: 5, g: null, role: 'normal' },

  // ── Karbohydrat ────────────────────────────────────────────────────────
  { id: 'potet', label: 'Potet', syn: ['potet', 'poteter', 'mandelpotet'], kcal: 75, protein: 2, g: 110, role: 'normal' },
  { id: 'ris', label: 'Ris', syn: ['ris', 'jasminris', 'basmatiris', 'grøtris'], kcal: 355, protein: 7, g: null, role: 'normal' },
  { id: 'pasta', label: 'Pasta', syn: ['pasta', 'spaghetti', 'penne', 'makaroni', 'fusilli', 'tagliatelle'], kcal: 360, protein: 12, g: null, role: 'normal' },
  { id: 'nudler', label: 'Nudler', syn: ['nudler', 'eggnudler', 'risnudler'], kcal: 350, protein: 11, g: null, role: 'normal' },
  { id: 'brod', label: 'Brød', syn: ['brød', 'grovbrød', 'loff', 'rundstykker'], kcal: 250, protein: 9, g: null, role: 'normal' },
  { id: 'tortilla', label: 'Tortillalefser', syn: ['tortilla', 'tortillalefser', 'lefser', 'wraps'], kcal: 300, protein: 8, g: 45, role: 'normal' },
  { id: 'lasagneplater', label: 'Lasagneplater', syn: ['lasagneplater', 'lasagne'], kcal: 355, protein: 12, g: null, role: 'normal' },
  { id: 'couscous', label: 'Couscous', syn: ['couscous', 'bulgur', 'quinoa'], kcal: 350, protein: 12, g: null, role: 'normal' },
  ...
  { id: 'hermetiske_tomater', label: 'Hermetiske tomater', syn: ['hermetiske tomater', 'knuste tomater', 'tomatsaus', 'passata'], kcal: 32, protein: 1.3, g: null, role: 'normal' },
  { id: 'agurk', label: 'Agurk', syn: ['agurk', 'slangeagurk'], kcal: 15, protein: 0.7, g: 300, role: 'normal' },
  { id: 'salat', label: 'Salat', syn: ['salat', 'isbergsalat', 'isbergmix', 'ruccola', 'salatmix'], kcal: 15, protein: 1, g: 200, role: 'normal' },
  ...
  { id: 'sopp', label: 'Sopp', syn: ['sopp', 'champignon', 'aromasopp'], kcal: 22, protein: 3.1, g: null, role: 'normal' },
  { id: 'mais', label: 'Mais', syn: ['mais', 'maiskorn'], kcal: 86, protein: 3.2, g: null, role: 'normal' },
  { id: 'erter', label: 'Erter', syn: ['erter', 'sukkererter'], kcal: 81, protein: 5.4, g: null, role: 'normal' },
  { id: 'spinat', label: 'Spinat', syn: ['spinat', 'babyspinat'], kcal: 23, protein: 2.9, g: null, role: 'normal' },
  ...
  { id: 'buljong', label: 'Buljong', syn: ['buljong', 'kraft', 'fond'], kcal: 10, protein: 1, g: null, role: 'background' },
  ...
  { id: 'kokosmelk', label: 'Kokosmelk', syn: ['kokosmelk'], kcal: 180, protein: 2, g: null, role: 'normal' },
  { id: 'salsa', label: 'Salsa', syn: ['salsa', 'tacosaus'], kcal: 45, protein: 1.2, g: null, role: 'normal' },
  { id: 'mel', label: 'Mel', syn: ['mel', 'hvetemel', 'maizena'], kcal: 340, protein: 10, g: null, role: 'background' },
  { id: 'sukker', label: 'Sukker', syn: ['sukker', 'brunt sukker'], kcal: 400, protein: 0, g: null, role: 'background' },
];
...
export function conceptFor(text) {
  ...
  for (const { syn, c } of INDEX) {
    ...
    for (const w of tokens) {
      ...
      if (w === syn) return c;
      if (w.startsWith(syn) && w.length - syn.length <= 7) {
        // Fuge-e/-s i norske sammensetninger: «laks·e·postei», «kjøtt·s·kake».
        const tail = w.slice(syn.length).replace(/^[es]/, '');
        // «laksefilet» ja, «laksepostei» nei.
        if (DERIVED_SUFFIXES.some((d) => tail === d || tail.startsWith(d))) break;
        return c;
      }
    }
  }
