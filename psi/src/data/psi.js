...
export const sports = [
  ...
  },
  {
    ...
    longDescription: {
      nb: 'PSI Klatregruppa har fast lavterskeløkt hos Høyt Under Taket i Skien hver tirsdag. Gruppa har eget sikkerhetsutstyr, som gjør det lett for nye å prøve.\n\nGjennom semesteret kan det bli uteklatring, kurs og temakvelder i tillegg. Følg med i Spond.',
      en: 'PSI Klatregruppa has a fixed low-threshold session at Høyt Under Taket in Skien every Tuesday. The group has its own safety gear, which makes it easy for newcomers to try.\n\nThrough the semester there may also be outdoor climbing, courses and theme evenings. Keep an eye on Spond.',
    },
