...
// Kilde: src/lib/foodConcepts.js. Kjør `npm run sync:shared` etter endringer der.
...
export const CONCEPTS = [
  // ── Kjøtt ──────────────────────────────────────────────────────────────
  { id: 'kjottdeig', label: 'Kjøttdeig', syn: ['kjøttdeig', 'karbonadedeig', 'hakket storfe'], kcal: 176, protein: 19, g: null, pack: 400, role: 'bearing' },
  ...
  { id: 'lasagneplater', label: 'Lasagneplater', syn: ['lasagneplater', 'lasagne'], kcal: 355, protein: 12, g: null, pack: 250, role: 'normal' },
  ...
  { id: 'hermetiske_tomater', label: 'Hermetiske tomater', syn: ['hermetiske tomater', 'knuste tomater', 'tomatsaus', 'passata'], kcal: 32, protein: 1.3, g: null, pack: 400, role: 'normal' },
